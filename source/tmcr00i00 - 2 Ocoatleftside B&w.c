...
int		TP_SearchGuide( void )
	{
		...
		// Data check
			if((0<guide_pos[0])&&(0<guide_pos[1])) {
                IGuidePos[DataX] = min( guide_pos[0] + 147, guide_pos[1]+ 147)-offset_x; //11911 IGuidePos[DataX] = min( guide_pos[0], guide_pos[1])-offset_x;
			} else if( 0<guide_pos[0] ) {
                IGuidePos[DataX] = (guide_pos[0] + 147)-offset_x; //11911 IGuidePos[DataX] = (guide_pos[0])-offset_x;
			} else if( 0<guide_pos[1] ) {
                IGuidePos[DataX] = (guide_pos[1] + 147)-offset_x; //11911 IGuidePos[DataX] = (guide_pos[1])-offset_x;
			} else {

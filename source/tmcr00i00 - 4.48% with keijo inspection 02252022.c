...
int		TP_SearchElect( void )
	{
        ...
        int 					n;
        int                     xl, yl, area_bl;
        int                     chipcornerlevel,color,cornerlimit = 35;
							...
							if( mode == ES_BLACK ) {
					                ...
					                // Lower START
					                    ...
					                    for( ry=ymax; ry>ymin; ry-=2 ) {
					                        ...
					                        // --- Viwe
					                        if( i_mode & INSPECT_STEP ) {
                                                //1R_move_gray_memory( grayPn, GrayP0, 0, 0, FxSize-1, FySize-1 );
                                               //1R_move_bin_memory( binPn, BinP0, 0, 0, FxSize-1, FySize-1 );
		...
		// 電極左右位置サーチ
			...
			// view
                ...
                if( i_mode & INSPECT_STEP ) {
                    ...
                    area_b.left   = ElecPosRough[DataUL][PosXmin];
                    area_b.right  = ElecPosRough[DataUL][PosXmin]+50;
                    area_b.top    = ElecPosRough[DataUL][PosYmin];
                    area_b.bottom = ElecPosRough[DataUL][PosYmin]+50;
                    ...
                    if(chipcornerlevel>=120)   chipcornerlevel = 55;
                   ...
                   // if(Kurolevel==ERROR) Kurolevel = 190;
                    ...
                    if( i_mode & INSPECT_STEP ) {
                        ...
                        sprintf( Comment2,"Corner left area limit: %d", cornerlimit);
                        sprintf( Comment, "%s\n%s", Comment1, Comment2 );
                        DrawMessage( Comment, color, 2, 2 );
                        R_DrawCls();
                    }

                    area_b2.left   = ElecPosRough[DataUL][PosXmax]-50;
                    area_b2.right  = ElecPosRough[DataUL][PosXmax];
                    area_b2.top    = ElecPosRough[DataUL][PosYmin];
                    area_b2.bottom = ElecPosRough[DataUL][PosYmin]+50;
                   ...
                   // if(Kurolevel==ERROR) Kurolevel = 190;
                    ...
                    if( i_mode & INSPECT_STEP ) {
                        ...
                        sprintf( Comment2,"Corner right area limit: %d", cornerlimit);
                        sprintf( Comment, "%s\n%s", Comment1, Comment2 );
                        DrawMessage( Comment, color2, 2, 2 );
                        R_DrawCls();
                    }

                    area_b3.left   = ElecPosRough[DataUL][PosXmin];
                    area_b3.right  = ElecPosRough[DataUL][PosXmin]+50;
                    area_b3.top    = ElecPosRough[DataUL][PosYmax]-50;
                    area_b3.bottom = ElecPosRough[DataUL][PosYmax];
                   ...
                   // if(Kurolevel==ERROR) Kurolevel = 190;
                    ...
                    area_b4.left   = ElecPosRough[DataUL][PosXmax]-50;
                    area_b4.right  = ElecPosRough[DataUL][PosXmax];
                    area_b4.top    = ElecPosRough[DataUL][PosYmax]-50;
                    area_b4.bottom = ElecPosRough[DataUL][PosYmax];
                   ...
                   // if(Kurolevel==ERROR) Kurolevel = 190;
                    ...
                    if((black_p >= cornerlimit)||(black_p2 >= cornerlimit)||(black_p3 >= cornerlimit)||(black_p4 >= cornerlimit)) return ERROR5;
		...
		// Chip edge data set
			...
			for( dn=0; dn<Mpx.runsize; dn++ ) {
				if( Mpx.runnumb[dn] == Elec[elec].BlobNo ) {
					...
					//v2.20 if((1==bIsLTR50)&&(0!=(Option & BACKINSP_MODE))){
                    if( ((1==bIsLTR50)&&(0!=(Option & BACKINSP_MODE))) || ((1==bIsLTR18)&&(0!=(Option & BACKINSP_MODE))) ){ //LTR18 11911 ELEC SEARCH POSITION INSPECTION
						// --- Xmin
						side = PosXmin;

...
static struct winb_para_tm WinbmParaInspect[] = {
    ...
    {	"Electrode Kasure Insp. level オフセット",	"Electrode Kasure Insp. level offse",		&ElecKasureInspLevel.nOffset,			100,	-100,	1		}, //11911 Kasure
    {	"Electrode Kasure Insp. level 下限値",		"Electrode Kasure Insp. level lower limit",&ElecKasureInspLevel.nLower,			255,	0,		1		},//11911 Kasure
    {	"Electrode Kasure Insp. level 上限値",		"Electrode Kasure Insp. level upper limit",&ElecKasureInspLevel.nUpper,			255,	0,		1		},//11911 Kasure
	{	"--- Bin measure [Elec] --------",	"--- Bin measure [Elec] --------",	&WorkParaDummy,    				0,		0,		0,		WorkParaCommentDummy	},
